...
simulations <- read_csv('https://raw.githubusercontent.com/steodose/club-elo/refs/heads/main/simulations.csv')
...
2025-26 forecasts coming soon...

```{r}

## Probabilities by position table
iSim <- 10000
...
league_table_gt <- left_join(league_table3, team_mapping_2024, by = c("Team" = "team"))
