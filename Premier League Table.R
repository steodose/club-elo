...
epl_rankings %>%
  ...
  gtsave("Premier League Table.png")


# Add  logo
epl_table_with_logo <- add_logo(
  plot_path = "/Users/Stephan/Desktop/R Projects/club-elo/Premier League Table.png", # url or local file for the plot
...
magick::image_write(epl_table_with_logo, "Premier League Table with Logo.png")
